...
/*const getTranslation = (lang: string) => (lang === "ar" ? ar : fr);

export const createLocalizedData = (lang: string)=> {
  const t = createT(getTranslation(lang));*/
export default function creatDataCard(lang: string) : SectionType[] {
  ...
  return [
  {
    icon: (
      ...
      title: t.cardsSections.calculationsTitle,
      text: t.cardsSections.calculationsDescription,
    call: [{
        text: t.cardsSections.readAbout,
        url: t.cardsSections.aboutUrl,
        icon : (<></>)
    }, {
        text: t.cardsSections.sourceCode,
  ...
  },
  {
    ...
    title: t.cardsSections.installApkTitle,
    text: t.cardsSections.installApkDescription,
    call: [{
        text: t.cardsSections.install,
        url: 'https://github.com/krnl0xsns1nk/7asib-app/releases/download/v1.0.0/7asib.apk',
  ...
  },
  {
    ...
    title: t.cardsSections.reportErrorTitle,
    text: t.cardsSections.reportErrorDescription,
    call: [{ 
        text: t.cardsSections.report,
        url: 'https://github.com/krnl0xsns1nk/7asib/issues',
  ...
  },
  {
    ...
    title: t.cardsSections.quickInfoTitle,
    text:  t.cardsSections.quickInfoDescription,
    call: [{
        text: t.cardsSections.starUs,
        url: 'https://github.com/krnl0xsns1nk/7asib',
        icon:(<svg width="12px" height="12px" viewBox="-1.44 -1.44 26.88 26.88" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="Interface / External_Link"> <path id="Vector" d="M10.0002 5H8.2002C7.08009 5 6.51962 5 6.0918 5.21799C5.71547 5.40973 5.40973 5.71547 5.21799 6.0918C5 6.51962 5 7.08009 5 8.2002V15.8002C5 16.9203 5 17.4801 5.21799 17.9079C5.40973 18.2842 5.71547 18.5905 6.0918 18.7822C6.5192 19 7.07899 19 8.19691 19H15.8031C16.921 19 17.48 19 17.9074 18.7822C18.2837 18.5905 18.5905 18.2839 18.7822 17.9076C19 17.4802 19 16.921 19 15.8031V14M20 9V4M20 4H15M20 4L13 11" stroke="#ffffff" strokeWidth="1.464" strokeLinecap="round" strokeLinejoin="round"></path> </g> </g></svg>)
    } , {
        text: t.cardsSections.readAbout, url: t.cardsSections.aboutUrl
    }]
  }
];
}
